...
/**
 * \file    test/phpunit/CoworkFunctionalTest.php
 * \ingroup cowork
 ...
 * @package Testcowork
 */
class CoworkFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 230610; // TODO: autodetect?
	...
	{
		$this->url('/custom/cowork/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('cowork/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/cowork/admin/about.php');
		$this->authenticate();
		return $this->assertContains('cowork/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('coworkwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCowork_CoworkTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCowork_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
